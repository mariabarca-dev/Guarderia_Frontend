    ...
    <c:choose>
        ...
        <c:otherwise>
            <div class="alert alert-danger shadow-sm" role="alert">
                ...
                <p class="mb-0">Su rol actual (<strong>${userRole}</strong>) no tiene los permisos necesarios para visualizar la gestión de asignaciones de vehículos a garages.</p>
            </div>
        </c:otherwise>
    </c:choose>
